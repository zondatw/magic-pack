...
```shell
# x86_64
wget https://github.com/zondatw/magic-pack/releases/latest/download/magic-pack_0.10.1_amd64.deb
sudo apt install ./magic-pack_0.10.1_amd64.deb

# arm64 (e.g. Raspberry Pi, AWS Graviton)
wget https://github.com/zondatw/magic-pack/releases/latest/download/magic-pack_0.10.1_arm64.deb
sudo apt install ./magic-pack_0.10.1_arm64.deb
```
